...
/**
 * Oracle page handler adapter, using the ANSI offset-fetch syntax supported since Oracle 12c.
 *
 * @author liam
 */
public class OraclePageHandlerAdapter implements PageHandlerAdapter {
    
    @Override
    public boolean supports(String dataSourceType) {
        return PersistenceConstant.ORACLE.equals(dataSourceType);
    }
